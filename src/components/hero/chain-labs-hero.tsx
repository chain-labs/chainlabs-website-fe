                      ...
                      {showPersonalisedCTA ? (
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Preview recommendations, missions, and tailored
                                messaging tuned to your goal.
                              </p>
                            </div>
                          </div>
                          <Button
                            type="button"
                            onClick={handleShowPersonalisedSite}
                            size="lg"
                            className="group mt-4 w-full justify-between bg-primary text-primary-foreground hover:bg-primary/90"
                          >
                            <span>Take me to my personalised site</span>
                        ...
                        >
                          <div className="flex flex-col">
                            ...
                            <InputContainer
                              inputValue={inputValue + voiceInputValue}
                              isFocused={isFocused}
